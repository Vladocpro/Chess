                 ...
                 <div className={'flex items-center justify-between gap-3 '} key={gameInvitation?.invitationID}>
                    <Link className={'flex items-center gap-2 sm:gap-3'}
                       ...
                       <div className={'flex flex-col'}>
                          ...
                          <span
                              className={'text-sm hidden sm:inline-block'}>{gameInvitation?.receiver?.rating} Elo</span>
                       </div>
                    </Link>
                    ...
                    <div className={'flex gap-5'}>
                       ...
                       <Tooltip text={'Unsend Invitation'}
                                onClick={() => handleUnsendGameInvitation('sent', gameInvitation)}>
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2}
                               stroke="currentColor" className="w-8 h-8 cursor-pointer bg-primaryLight stroke-white">
                 ...
                 <div className={'flex items-center justify-between gap-3 '} key={gameInvitation?.invitationID}>
                    ...
                    <div className={'flex  gap-5'}>
                       <Tooltip text={'Accept Invitation'} onClick={() => handleAcceptGameInvitation(gameInvitation)}>
                          <svg xmlns="http://www.w3.org/2000/svg" fill='none' viewBox="0 0 24 24" strokeWidth={2}
                               className="w-8 h-8 rounded-sm cursor-pointer bg-primaryLight stroke-white">
                             <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5"/>
                          </svg>
                       </Tooltip>
                       <Tooltip text={'Decline Invitation'}
                                onClick={() => handleRejectGameInvitation('received', gameInvitation)}>
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2}
                               stroke="currentColor" className="w-8 h-8 cursor-pointer bg-primaryLight stroke-white">
                             <path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12"/>
                          </svg>
