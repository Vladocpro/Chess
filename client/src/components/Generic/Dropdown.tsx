...
const Dropdown: FC<DropDownProps> = ({
   ...
   return (
       <div className={`relative ${dropdownStyles}`} ref={dropdownRef}>
          <div className={`flex gap-3 items-center px-1 cursor-pointer select-none ${selectStyles}`}
          ...
          {/*Dropdown Options*/}
          <div
              className={`${isOpen ? "translate-y-2  opacity-100 visible" : "-translate-y-5 opacity-0 invisible  "} ${containerStyles} transition-all duration-300  rounded-lg select-none  absolute z-10 right-0`}>
