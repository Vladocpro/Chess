...
const GameHistory: FC<GameHistoryProps> = ({gameHistory}) => {
   ...
   return (
       <div
           className={'flex flex-col overflow-hidden  bg-primary rounded-md lg:ml-10 h-[350px] lg:h-[600px] w-[360px] sm:w-[600px] lg:w-[300px] xl:w-[360px]  pt-4  my-8 lg:my-[57px]'}>
