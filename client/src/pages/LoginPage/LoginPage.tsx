...
const LoginPage = () => {
   ...
   const handleLogin = async () => {
      postFetch("/auth/login", {email: email, password: password}).then((data) => {
       ...
       <div className={'flex flex-col justify-center items-center h-screen w-screen'}>
          <div className={'flex flex-col items-center w-full'}>
             ...
             <div className={'flex flex-row items-end mb-10'}>
                <svg className={"w-11 h-11 sm:w-14 sm:h-14 align-middle fill-primaryGreen overflow-hidden"}
                     viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                   <path
                       d="M512 375.466667c-102.4 0-187.733333-85.333333-187.733333-187.733334S409.6 0 512 0s187.733333 85.333333 187.733333 187.733333S614.4 375.466667 512 375.466667z m0-341.333334c-85.333333 0-153.6 68.266667-153.6 153.6s68.266667 153.6 153.6 153.6 153.6-68.266667 153.6-153.6S597.333333 34.133333 512 34.133333z"
                       fill=""/>
                   <path
                       d="M512 477.866667c-136.533333 0-184.32-64.853333-184.32-68.266667-3.413333-3.413333-3.413333-6.826667-3.413333-10.24v-44.373333-6.826667c3.413333-3.413333 17.066667-27.306667 81.92-40.96 10.24-3.413333 17.066667 3.413333 20.48 13.653333 3.413333 10.24-3.413333 17.066667-13.653334 20.48-37.546667 6.826667-51.2 17.066667-54.613333 23.893334v30.72c10.24 10.24 54.613333 47.786667 153.6 47.786666s143.36-37.546667 153.6-47.786666v-30.72c-3.413333-3.413333-20.48-13.653333-54.613333-23.893334-10.24-3.413333-13.653333-10.24-13.653334-20.48s10.24-13.653333 20.48-13.653333c64.853333 13.653333 78.506667 37.546667 81.92 44.373333v51.2c0 3.413333 0 6.826667-3.413333 10.24 0 0-47.786667 64.853333-184.32 64.853334z"
                       fill=""/>
                   <path
                       d="M512 887.466667c-163.84 0-211.626667-51.2-218.453333-58.026667-3.413333-6.826667-6.826667-13.653333 0-20.48 0 0 98.986667-167.253333 98.986666-348.16 0-10.24 6.826667-17.066667 17.066667-17.066667s17.066667 6.826667 17.066667 17.066667c0 163.84-75.093333 310.613333-98.986667 354.986667 20.48 13.653333 71.68 37.546667 184.32 37.546666 112.64 0 163.84-23.893333 184.32-37.546666-23.893333-44.373333-98.986667-191.146667-98.986667-354.986667 0-10.24 6.826667-17.066667 17.066667-17.066667s17.066667 6.826667 17.066667 17.066667c0 184.32 98.986667 348.16 98.986666 348.16 3.413333 6.826667 3.413333 13.653333 0 20.48-6.826667 6.826667-54.613333 58.026667-218.453333 58.026667z"
                       fill=""/>
                   <path
             ...
             {/*FORM*/}
             <div
                 className={'flex flex-col text-center w-[20rem] sm:w-[28rem]  md:w-[35rem] shadow-xl border-2 mx-2 border-secondaryDark bg-secondaryDark rounded-lg'}>
                ...
                <div
                    className={'flex justify-center items-center text-center  h-10 sm:h-12 w-full rounded-b-md bg-secondaryDark cursor-pointer'}
