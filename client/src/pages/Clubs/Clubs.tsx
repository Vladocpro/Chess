       ...
       <div className={'flex gap-6 justify-center mt-0 sm:mt-10 mb-7'}>
          <div className={'bg-primary py-5 px-5 rounded-md flex-[2] max-w-[900px]'}>
             ...
             <div className={'flex items-center mt-7 mb-5 justify-between gap-2'}>
                <span className={'text-primaryGreen text-sm sm:text-lg font-bold'}>Do you want to create your own club ?</span>
                <button onClick={() => setModalIsOpen(true)} className={'text-sm sm:text-base bg-primaryLight hover:bg-secondaryGreen duration-200 rounded-md py-2 sm:py-3 px-4 sm:px-7 min-w-[145px]'} >Create a Club</button>
             </div>
                   ...
                   ? (
                       ...
                       <div>
                          <div className={'flex items-center gap-3 sm:gap-5 mb-1 '}>
                             ...
                             <span className={'bg-input rounded-md text-sm sm:text-base px-1'}>{popularClubs.length} </span>
                          </div>
                             ...
                             {popularClubs?.map((club) => (
                                 <div className={'flex items-center justify-between gap-5'} key={club._id}>
                                    <Link className={'flex flex-[1] items-center gap-2 sm:gap-5'} to={`/club/${club._id}`}>
                                       <img  className={'w-[2.25rem] h-[2.25rem] sm:w-[3.75rem] sm:h-[3.75rem] '} src={'club.png'} alt={'chess club'}/>
                   ...
                   : (
                           ...
                           <div>
                              <div className={'flex items-center gap-3 sm:gap-5 mb-1 '}>
                                 ...
                                 <span className={'bg-input rounded-md text-sm sm:text-base px-1'}>{filteredClubs.length} </span>
                              </div>
                              <div className={'flex flex-col gap-3'}>
